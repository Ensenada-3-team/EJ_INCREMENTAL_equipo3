                              ...
                              let html = `
                                    ...
                                    <div class="likesCounter d-flex justify-content-between w-100">
                                          <div class="d-flex mt-2">
                                                <div id="sumLikes" class="mt-2">${post.reactions}</div>
                                                <button class="btn like-btn" onclick="toggleLike(this)">
                                                <i class="bi bi-heart-fill"></i>
                                                </button>

                                                <div id="sumDisLikes" class="mt-2">0</div>
                                                <button class="btn dislike-btn" onclick="toggleDisLike(this)">
